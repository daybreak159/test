...
try:
    ...
    # ALFWorld pulls optional environment dependencies such as textworld.
    # Keep LoCoMo/LongMemEval/HotpotQA runnable when those packages are absent.
...
def main():
    ...
    if args.dataset == "alfworld" and _ALFWORLD_IMPORT_ERROR is not None:
        raise ImportError(
            "ALFWorld dependencies are required only for --dataset alfworld. "
            "Install textworld/alfworld or use a non-ALFWorld dataset."
