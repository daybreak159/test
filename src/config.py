...
class AgenticMemoryConfig:
    def __init__(self):
        ...
        self.run_dir = None
        self.api_cache_mode = "off"
        self.api_cache_dir = None
...
def get_agentic_memory_args():
    ...
    # Training args
    parser.add_argument('--controller-backend', type=str, default='torch',
                        choices=['torch', 'jittor'],
                        help='Controller backend for PPO training')
    ...
    parser.add_argument('--controller-trace-records', type=str, default=None,
                        help='Optional JSONL path for dumping controller rollout records')
    parser.add_argument('--run-dir', type=str, default=None,
                        help='Optional run directory for online artifacts and summaries')
    parser.add_argument('--api-cache-mode', type=str, default='off',
                        choices=['off', 'live', 'replay'],
                        help='API cache mode: off, live records responses, replay reads cached responses')
    parser.add_argument('--api-cache-dir', type=str, default=None,
                        help='Directory for live/replay API request-response cache')
